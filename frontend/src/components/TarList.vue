<template>
  <div class="p-6">
    <h1 class="text-3xl font-semibold my-4 text-gray-800">Download Tar Files</h1>
  ...
  <div class="p-4 m-2">
    ...
    <div v-if="tarlist.length != 0">
      <li v-for="x in tarlist" class="flex items-center gap-6">{{ x }}
        <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
        <svg @click="download_tar(x)" fill="#000000" height="20px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
		...
		C15.092,18.979,14.62,18.426,14.62,18.426z" /><g>
            </g>
            <g>
            </g>
            <g>
        ...
        <svg @click="delete_tar(x)" height="10px" width="10px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
export default {
  ...
  methods: {
    ...
    async delete_tar(file_name) {
      let delete_endpoint = '/api/method/flashdesk.api.pod_image.saved_file_delete';
      let file_json = {
        name: file_name
      }
