    ...
    <div class="bg-white">
      ...
      >
        <div class="flex justify-between items-center">
          <p class="text-black">
            <span class="text-md font-bold">Job Name: </span>{{ job.job_name }}
          </p>
        </div>
        ...
        <div class="mt-2">
          <div class="mb-2">
            <p class="text-sm text-black">Status: {{ job.status }}</p>
            <p class="text-sm text-black">Started At: {{ job.started_at }}</p>
            <p class="text-sm text-black">Ended At: {{ job.ended_at }}</p>
            <p class="text-sm text-black">
              Time Taken: {{ job.time_taken }} seconds
            </p>
            <br />
            <pre class="text-sm text-black p-2 bg-gray-100 rounded-md">{{
              job.arguments
            }}</pre>
          </div>
        </div>
