...
def create_vector_db():
	...
	vectorstore = Chroma.from_documents(
		documents=texts,
		embedding=OllamaEmbeddings(base_url=base_url, model="llama2"),
		persist_directory=os.path.abspath(chromadb_path),
	)
	vectorstore.persist()
...
def start_processing():
	...
	return {
		"status": "success",
		"message": "The embedding process has started in the background. Please check Events for more informstion.",
	}
